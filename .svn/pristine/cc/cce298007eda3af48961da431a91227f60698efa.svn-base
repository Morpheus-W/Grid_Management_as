...
import com.cn7782.management.android.activity.datetimepickers.SimpleMonthAdapter.CalendarDay;
...
//        mCalendar.set(Calendar.HOUR_OF_DAY, value);
//        mCalendar.set(Calendar.SECOND, value);
//        mCalendar.set(Calendar.MINUTE, value);
