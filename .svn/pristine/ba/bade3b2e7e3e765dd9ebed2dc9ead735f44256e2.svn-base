...
public final class LunarUtil {
    ...
    public static String getLunarAlmanac(String year, String month, String day) {
    	Date sDObj;
        String s;
        int SY, SM, SD;
        int sy;
...
//        s += cDay(getDay()) + " ";
//        s += cyclical(getYearCyl()) + "年" + cyclical(getMonCyl()) + "月"+ cyclical(getDayCyl()) + "日";
        s = "农历 "  + monthNong[getMonth()] + "月"+ cDay(getDay());
        return s;
    }public static String getLunarMonthDay2(String year, String month, String day) {
        Date sDObj;
        String s;
        int SY, SM, SD;
        int sy;
